...
const { verificarIntegridad } = require('./utils/verificador_sistema');
...
app.use('/api/catalogos', catalogsRoutes); // Alias para compatibilidad
app.use('/api/admissions', admissionsRoutes);
app.use('/api/admisiones', admissionsRoutes); // Alias para soberanía lingüística y cumplimiento de E2E
...
const iniciarServidor = async () => {
    try {
        ...
        await verificarIntegridad(); // Pre-flight de integridad soberana
